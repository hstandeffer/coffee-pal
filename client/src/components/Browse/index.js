...
const BrowsePage = () => {
  ...
  return (
    <BrowseWrapper>
      ...
      <BrowseFiltersWrapper>
        <ResponsiveFiltersDiv data-testid="browse:filters" filtering={filtering}>
          <BrowseFiltersHeaderDiv>
            <h2>Filters</h2>
          ...
          <MobileFiltersFooter filtering={filtering}>
...
const OpenMobileFilters = ({ filtering, setFiltering }) => (
  <Hidden mdUp>
    <OpenMobileFiltersButton filtering={filtering} onClick={() => setFiltering(!filtering)}>
